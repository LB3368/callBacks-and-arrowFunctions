...
//event loopLinks to an external site https://www.youtube.com/watch?v=cCOL7MC4Pl0.
...
// 1. Accept a callback function, or
// 2. Return a promise
...
//f there's only a single expression (not a statement), curly braces are optional:
...
console.log('/n/n************* when you do not use a keyword in an arrow function ')


//❓ Describe what a callback function is in your own words.

console.log('/n/n========A function passed into another function as the argument to be executed later in response to an event==========/n/n')